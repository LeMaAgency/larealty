    ...
    <section class="about">
        ...
        <div class="container-index about-container">
            <div class="about-title">
                <? $APPLICATION->IncludeFile(SITE_DIR . 'include/old/main/about/title.php'); ?>
            </div>
            <div class="about-text">
                <? $APPLICATION->IncludeFile(SITE_DIR . 'include/old/main/about/description.php'); ?>
            </div>
            <? $APPLICATION->IncludeFile(SITE_DIR . 'include/old/main/about/button.php'); ?>
        </div>
    </section>
    <!-- /ABOUT BLOCK -->
    <!-- BENEFITS -->
