...
$arFilter = Array(
	...
	"ID_1"			=>$find_id_1,
	"ID_2"			=>$find_id_2,
	"PRICE_1"			=>$find_price_1,
	"PRICE_2"			=>$find_price_2,
...
?>
	...
	<tr class="js-find-price">
		<td><?echo GetMessage("IBLIST_A_F_FROM_TO_PRICE")?></td>
		<td nowrap>
			<input type="text" name="find_price_1" size="10" value="<?echo htmlspecialcharsex($find_price_1)?>">
			...
			<input type="text" name="find_price_2" size="10" value="<?echo htmlspecialcharsex($find_price_2)?>">
		</td>
	</tr>
	<tr>
