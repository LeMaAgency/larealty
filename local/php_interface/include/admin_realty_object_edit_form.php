    ...
    $(function() {
        ...
        $('#tr_PROPERTY_1 select').on('change', function(e) {
            ...
            switch($(this).val())
            {
                ...
                case '1':
                    sortProps = {
                        '#tr_edit1_csection4': [29, 13, 30, 31, 33, 34], //Адрес
                        '#tr_edit1_csection1': [2, 7, 19, 9, 6, 5, 4, 22, 23, 8, 21, 35, 24, 25], //Характеристики
                        '#tr_edit1_csection2': [38, 77, 39, 42, 40, 81, 41, 27, 48, 49, 45, 44], //Наличие
                ...
                case '2':
                    sortProps = {
                        ...
                        '#tr_edit1_csection1': [2, 86, 7, 19, 9, 6, 5, 20, 21, 4, 8, 24, 25, 57], //Характеристики
                        '#tr_edit1_csection2': [38, 77, 39, 78, 26, 43, 27, 46 /*, 47, 48, 51, 49*/], //Наличие
                        '#tr_edit1_csection3': [3, 50, 79] //Условия
                    };
                break;
                //Дома/дачи
                case '3':
                    sortProps = {
                        ...
                        '#tr_edit1_csection2': [38, 80, 42, 40, 81, 41, 43, 27, 48, 49, 45, 44], //Наличие
                ...
                case '49':
                    sortProps = {
                        ...
                        '#tr_edit1_csection2': [38, 39, 27, 47, 48, 51, 49], //Наличие
                ...
                case '50':
                    sortProps = {
                        ...
                        '#tr_edit1_csection2': [38, 39, 43, 26, 47, 48, 51, 49], //Наличие
                        '#tr_edit1_csection3': [3] //Условия
                    };
                break;
                //Здания
