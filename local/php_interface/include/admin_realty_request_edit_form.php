...
<script>
    $(function () {
        ...
        $('#tr_PROPERTY_106 input').on('change', function (e) {
            e.preventDefault();
        ...
        $('#tr_PROPERTY_88 select').on('change', function (e) {
            e.preventDefault();
            ...
            switch ($(this).val()) {
                ...
                case '94':
                    sortProps = {
                        '#tr_IBLOCK_ELEMENT_PROP_VALUE': [89, 90, 91, 92, 93, 94]
                    };
                    break;
                //Комнаты
                case '95':
                    sortProps = {
                        '#tr_IBLOCK_ELEMENT_PROP_VALUE': [90, 91, 92, 93, 94]
                    };
                    break;
                //Дома
                case '96':
                    sortProps = {
                        '#tr_IBLOCK_ELEMENT_PROP_VALUE': [89, 95, 96, 97, 93, 94]
                    };
                    break;
                //Дачи
                case '97':
                ...
                case '98':
                    sortProps = {
                        '#tr_IBLOCK_ELEMENT_PROP_VALUE': [96, 97, 98, 93, 94]
                    };
                    break;
                default:
                    $('[id^="tr_PROPERTY_"], #tr_NAME, #tr_CODE').hide();
