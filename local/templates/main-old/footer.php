...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer-bottom">
            <div class="footer-copyright"><? $APPLICATION->IncludeFile(SITE_DIR . 'include/old/footer/copyright.php'); ?></div>
            <div class="footer-social">
                <? $APPLICATION->IncludeFile(SITE_DIR . 'include/old/footer/social.php'); ?>
            </div>
        </div>
    </div>
</footer>
