                ...
                if($arResult["bDescPageNumbering"] === true):
                    ...
                    if($arResult["NavPageNomer"] < $arResult["NavPageCount"]):
                        if($arResult["bSavePage"]):
                            ...
                            ?>
                            <li><a aria-label="Previous" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"] + 1)?>"><?=GetMessage("lema_nav_prev")?></a>
                            </li>
                            <?
                        else:
                            if($arResult["NavPageCount"] == ($arResult["NavPageNomer"] + 1)):
                                ?>
                                <li><a aria-label="Previous" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=GetMessage("lema_nav_prev")?></a></li>
                                <?
                            else:
                                ?>
                                <li><a aria-label="Previous" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"] + 1)?>"><?=GetMessage("lema_nav_prev")?></a>
                    ...
                    do
                    {
                        ...
                        elseif($arResult["nStartPage"] == $arResult["NavPageCount"] && $arResult["bSavePage"] == false):
                            ...
                            ?>
                            <li>
                                <a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>"><?=$NavRecordGroupPrint?></a></li>
                    ...
                    if($arResult["NavPageNomer"] > 1):
                        ...
                        ?>
                        <li><a aria-label="Next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"] - 1)?>"><?=GetMessage("lema_nav_next")?></a>
                        </li>
                        <?
                    endif;
