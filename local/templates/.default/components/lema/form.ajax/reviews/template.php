...
<div class="container-index">
    ...
    <div class="top-slider-form">
        <form method="post" <?= $component->getFormClass(); ?> <?= $component->getFormAction(); ?>
            ...
            <div class="it-block">
                <input required type="text" id="form_field_name" name="name" placeholder="Имя"
                       class="call-order-input">
                <div class="it-error"></div>
            </div>
            <div class="it-block">
                <textarea required type="text" id="form_field_review" name="review" placeholder="Отзыв"
                          class="call-order-input"></textarea>
                <div class="it-error"></div>
            </div>
